        ...
        <div className="relative grid grid-cols-1 lg:grid-cols-2 h-[70vh] min-h-[500px]">
          ...
          <div className={`relative h-full ${!hasImages ? 'bg-gray-200 flex items-center justify-center' : ''}`}>
            {hasImages ? (
              ...
              <div className="text-gray-400 text-center p-8">
                ...
                <span className="text-lg">Photos coming soon</span>
              </div>
            )}
          </div>
          {/* Secondary Images */}
          <div className="hidden lg:grid grid-cols-2 grid-rows-2">
            {images.length > 1 ? (
              ...
              // Show placeholder grid when no secondary images
              Array.from({ length: 4 }).map((_, index) => (
                <div key={index} className="relative bg-gray-100 flex items-center justify-center">
              ...
              <div className="sticky top-28">
                ...
                <div className="bg-white border border-gray-200 p-8">
                  ...
                  <div className="space-y-4 mb-6">
                    ...
                    <a
                      href="mailto:matt@luxelivingmiami.com"
                      className="flex items-center text-[var(--charcoal)] hover:text-[var(--gold)] transition-colors"
                    >
                      <svg className="w-5 h-5 mr-3 text-[var(--gold)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
