      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-400 text-sm leading-relaxed max-w-md">
              ...
              Specializing in residential, waterfront, and lifestyle-driven properties.
            </p>
          </div>

          {/* Quick Links */}
          <div>
            <h4 className="text-xs tracking-[0.2em] uppercase mb-6 text-[var(--gold)]">
              Quick Links
            </h4>
        ...
        <div className="border-t border-gray-700 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 text-xs">
            &copy; {new Date().getFullYear()} Matt Edwards Real Estate. All rights reserved. FL MLS #36425
          </p>
